...
<html>
  <head>
    ...
    <?php
        if ($style == null) {
            echo "    <link rel=\"stylesheet\" type=\"text/css\" href=\".echo $BASEURL.theme/classic/css/style.css\" media=\"screen\">\n".
                 "    <link href=\".echo $BASEURL.theme/classic/css/style-responsive.css\" rel=\"stylesheet\" media=\"screen\">";
        } else {     
            echo "    <link rel=\"stylesheet\" type=\"text/css\" href=\".echo $BASEURL.theme/.echo $style./css/style.css\" media=\"screen\">\n".
                 "    <link href=\".echo $BASEURL.theme/.echo $style./css/style-responsive.css\" rel=\"stylesheet\" media=\"screen\">";
    ?>
    <style type="text/css">
        <!-- Global Styles -->
        <!--body {
