...
<body>
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="<? echo $BASEURL ?>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link <?php if ($BASEURL . 'index.php' == $_SERVER['PHP_SELF']) {
                                            echo " active";
                                        } ?>" href="<?php echo $BASEURL; ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($BASEURL . 'players.php' == $_SERVER['PHP_SELF']) {
                                            echo " active";
                                        } ?>" href="<?php echo $BASEURL; ?>players.php">Player Info</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($BASEURL . 'quest.php' == $_SERVER['PHP_SELF']) {
                                            echo " active";
                                        } ?>" href="<?php echo $BASEURL; ?>quest.php">Quest Info</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($BASEURL . 'worldmap.php' == $_SERVER['PHP_SELF']) {
                                            echo " active";
