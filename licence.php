...
</a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">IdleRPG Website</span> by 
...
Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License</a>.<br />Based on a work at 
<a xmlns:dct="http://purl.org/dc/terms/" href="http://idlerpg.net/" rel="dct:source">http://idlerpg.net/</a>.

For additional permissions please use the following contact page
<?php
if ($_POST['from'] && $_POST['text']) {
        mail($admin_email,"Licence IRPG: ".$_POST['from'],
             "Name: ".$_POST['name']."\nE-mail: ".$_POST['from']."\n\n".
